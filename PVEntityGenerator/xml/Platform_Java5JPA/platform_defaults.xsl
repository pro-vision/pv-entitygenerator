...
<xsl:variable name="platform" select="$project-settings/platforms/platform[@name='Java5JPA']"/>
...
<xsl:key name="generate-entity-platform" match="/pventitygenerator-data/project-settings/platforms/platform[@name='Java5JPA']/entity-generation/generate-entity" use="@entity"/>
