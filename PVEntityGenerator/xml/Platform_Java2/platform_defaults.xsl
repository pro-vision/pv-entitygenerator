...
<xsl:variable name="platform" select="$project-settings/platforms/platform[@name='Java2']"/>
...
<xsl:key name="generate-entity-platform" match="/pventitygenerator-data/project-settings/platforms/platform[@name='Java2']/entity-generation/generate-entity" use="@entity"/>
