...
<xsl:template match="entity" mode="create-default">
   ...
   */
    ...
    <xsl:text>    return createGeneric(dbo, pcon);
  }
   ...
   */
    ...
    return createGeneric(pdbo, pcon);
  }
...
<xsl:template match="entity" mode="find-default">
   ...
   */
    ...
    return findByPrimaryKey(</xsl:text>
...
<xsl:template match="entity" mode="find-foreign-key">
   ...
   */
    ...
    <xsl:text>  public static java.util.List&lt;</xsl:text><xsl:value-of select="$entity"/><xsl:text>&gt; </xsl:text>
    ...
    <xsl:text>    java.util.List&lt;</xsl:text><xsl:value-of select="$entity"/><xsl:text>&gt; aresult = executeStatementToArray(</xsl:text>
    <xsl:value-of select="$entity"/><xsl:text>.class, stmt);
    stmt.close();
</xsl:text>
    <xsl:text>    return aresult;
</xsl:text>
    <xsl:text>  }
